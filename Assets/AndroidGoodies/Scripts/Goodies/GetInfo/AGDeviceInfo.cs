namespace DeadMosquito.AndroidGoodies
{
	...
	public static class AGDeviceInfo
	{
		...
		public static class VersionCodes
		{
			...
			/// </summary>
			[PublicAPI]
			public const int S = 31;
			
			/// <summary>
			/// Android R
			/// </summary>
			[PublicAPI]
			public const int S_V2 = 32;
			...
			/// <summary>
			/// Android UPSIDE_DOWN_CAKE
			/// </summary>
			[PublicAPI]
			public const int UPSIDE_DOWN_CAKE = 34;
		}
		...
		public static class SystemFeatures
		{
			...
			[PublicAPI]
			public const string FEATURE_CAMERA_CAPABILITY_MANUAL_SENSOR =
				"android.hardware.camera.capability.manual_sensor";

			[PublicAPI]
			public const string FEATURE_CAMERA_CAPABILITY_MANUAL_POST_PROCESSING =
			...
			[PublicAPI]
			public const string FEATURE_TOUCHSCREEN_MULTITOUCH_DISTINCT =
				"android.hardware.touchscreen.multitouch.distinct";

			[PublicAPI]
			public const string FEATURE_TOUCHSCREEN_MULTITOUCH_JAZZHAND =
			...
			[PublicAPI]
			public const string FEATURE_FAKETOUCH_MULTITOUCH_DISTINCT =
				"android.hardware.faketouch.multitouch.distinct";

			[PublicAPI]
			public const string FEATURE_FAKETOUCH_MULTITOUCH_JAZZHAND =
			...
			[PublicAPI]
			public static bool HasFlashlight => AGUtils.HasSystemFeature(FEATURE_CAMERA_FLASH);
		...
		public static string GetAndroidId()
		{
			...
			try
			{
				using (var objResolver = AGUtils.ContentResolver)
				{
					...
					{
						var ANDROID_ID = clsSecure.GetStaticStr("ANDROID_ID");
						var androidId = clsSecure.CallStaticStr("getString", objResolver, ANDROID_ID);
						return androidId;
					}
				}
			}
		...
		/// </summary>
		[PublicAPI]
		public static string BASE_OS => GetDeviceStrProperty<string>(C.AndroidOsBuildVersion, "BASE_OS");

		/// <summary>
		/// The current development codename, or the string "REL" if this is a release build.
		/// </summary>
		[PublicAPI]
		public static string CODENAME => GetDeviceStrProperty<string>(C.AndroidOsBuildVersion, "CODENAME");

		/// <summary>
		/// The internal value used by the underlying source control to represent this build.
		/// </summary>
		[PublicAPI]
		public static string INCREMENTAL => GetDeviceStrProperty<string>(C.AndroidOsBuildVersion, "INCREMENTAL");

		/// <summary>
		/// The developer preview revision of a prerelease SDK.
		/// </summary>
		[PublicAPI]
		public static int PREVIEW_SDK_INT => GetDeviceStrProperty<int>(C.AndroidOsBuildVersion, "PREVIEW_SDK_INT");

		/// <summary>
		/// The user-visible version string.
		/// </summary>
		[PublicAPI]
		public static string RELEASE => GetDeviceStrProperty<string>(C.AndroidOsBuildVersion, "RELEASE");

		/// <summary>
		/// The user-visible SDK version of the framework; its possible values are defined in Build.VERSION_CODES.
		/// </summary>
		[PublicAPI]
		public static int SDK_INT => GetDeviceStrProperty<int>(C.AndroidOsBuildVersion, "SDK_INT");

		/// <summary>
		/// The user-visible security patch level.
		/// </summary>
		[PublicAPI]
		public static string SECURITY_PATCH => GetDeviceStrProperty<string>(C.AndroidOsBuildVersion, "SECURITY_PATCH");
