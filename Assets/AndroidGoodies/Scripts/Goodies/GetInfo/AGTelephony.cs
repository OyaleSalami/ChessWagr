	...
	public static class AGTelephony
	{
		...
		public static PhoneStates CallState
		{
			get
			{
				...
				return (PhoneStates) AGSystemService.TelephonyService.CallIntSafe("getCallState");
			}
		}
		...
		/// </summary>
		[PublicAPI]
		public static string NetworkOperator => AGUtils.IsNotAndroid() ? string.Empty : AGSystemService.TelephonyService.CallStrSafe("getNetworkOperator");
		...
		/// </summary>
		[PublicAPI]
		public static string NetworkOperatorName => AGUtils.IsNotAndroid() ? string.Empty : AGSystemService.TelephonyService.CallStrSafe("getNetworkOperatorName");
		...
		/// </summary>
		[PublicAPI]
		public static string SimCountryIso => AGUtils.IsNotAndroid() ? string.Empty : AGSystemService.TelephonyService.CallStrSafe("getSimCountryIso");
		...
		/// </summary>
		[PublicAPI]
		public static string SimOperator => AGUtils.IsNotAndroid() ? string.Empty : AGSystemService.TelephonyService.CallStrSafe("getSimOperator");
		...
		/// </summary>
		[PublicAPI]
		public static string SimOperatorName => AGUtils.IsNotAndroid() ? string.Empty : AGSystemService.TelephonyService.CallStrSafe("getSimOperatorName");
		...
		/// </summary>
		[PublicAPI]
		public static string SimSerialNumber => AGUtils.IsNotAndroid() ? string.Empty : AGSystemService.TelephonyService.CallStrSafe("getSimSerialNumber");
		...
		/// </summary>
		[PublicAPI]
		public static string SubscriberId => AGUtils.IsNotAndroid() ? string.Empty : AGSystemService.TelephonyService.CallStrSafe("getSubscriberId");
		...
		/// </summary>
		[PublicAPI]
		public static string VoiceMailAlphaTag => AGUtils.IsNotAndroid() ? string.Empty : AGSystemService.TelephonyService.CallStrSafe("getVoiceMailAlphaTag");
		...
		/// </summary>
		[PublicAPI]
		public static string VoiceMailNumber => AGUtils.IsNotAndroid() ? string.Empty : AGSystemService.TelephonyService.CallStrSafe("getVoiceMailNumber");
		...
		/// </summary>
		[PublicAPI]
		public static bool IsNetworkRoaming => !AGUtils.IsNotAndroid() && AGSystemService.TelephonyService.CallBool("isNetworkRoaming");
