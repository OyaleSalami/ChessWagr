namespace DeadMosquito.AndroidGoodies
{
	...
	public class Notification
	{
		...
		/// </summary>
		[PublicAPI]
		public string SortKey => AJO.CallStr("getSortKey");
		...
		/// </summary>
		[PublicAPI]
		public long TimeoutAfter => AJO.CallLong("getTimeoutAfter");
		...
		public class Builder
		{
			...
			void SetOpenThisApp(Dictionary<string, string> customData)
			{
				...
				var contentIntent = AndroidPendingIntent.GetActivity(androidIntent.AJO, AGUtils.RandomId());
			...
			/// </summary>
			[PublicAPI]
			public void SetSoundFromRawResource([NotNull] string soundFilename)
			{
				...
				var path = "android.resource://" + AGDeviceInfo.GetApplicationPackage() + "/raw/" + soundFilename;
				_builderAjo.CallAJO("setSound", AndroidUri.Parse(path));
			}
