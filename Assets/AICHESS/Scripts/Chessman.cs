...
public abstract class ChessmanAi : MonoBehaviour
{
    ...
    public ChessmanAi Clone()
    {
       return (ChessmanAi) this.MemberwiseClone();
    }
    ...
    public bool InDanger()
    {
        ...
        if(y - 1 >= 0)
        {
            ...
            if(piece != null && piece.isWhite != isWhite &&  piece.GetType() == typeof(KingAi))
                return true;
        }
        while (y-- > 0)
        {
        ...
        if(x + 1 <= 7 && y - 1 >= 0 && isWhite)
        {
            ...
            if(piece != null && piece.isWhite != isWhite && piece.GetType() == typeof(PawnAi))
                return true;
        }
        if(x + 1 <= 7 && y - 1 >= 0)
        {
    ...
    public bool KnightThreat(int x, int y)
    {
        if (x >= 0 && y >= 0 && x <= 7 && y <= 7)
        {
            ChessmanAi piece = BoardManager.Instance.Chessmans[x, y];
            // If the cell is empty
            if (piece == null)
                return false;
            ...
            if(piece.GetType() == typeof(KnightAi))
            {
    ...
    public bool KingInDanger(int x, int y)
    {
        ...
        ChessmanAi tmpChessman = BoardManager.Instance.Chessmans[x, y];
